...
public class GuestServiceTest {
        ...
        void getAllUsers() {
                ...
                GuestSearchResponse guestSearchResponseWithUserInfo = new GuestSearchResponse(
                                ResConstants.GUEST_FIND_ALL_USER_INFO,
                                List.of(guestDetailsWithUserInfo1, guestDetailsWithUserInfo2));
        ...
        void getGuestById() {
                ...
                GuestSearchResponse guestSearchResponseWithUserInfo = new GuestSearchResponse(
                                ResConstants.GUEST_FIND + GUEST1_ID + " with user info...",
                                List.of(guestDetailsWithUserInfo));
                GuestSearchResponse guestSearchResponseWithoutUserInfo = new GuestSearchResponse(
        ...
        void createNewGuest() {
                ...
                StepVerifier.create(guestService.createGuest(requestGuest, "today")).expectNextCount(1)
                                .verifyComplete();
        }
        ...
        void updateGuest_guestId() {
                ...
                GuestCreateUpdateResponse response = new GuestCreateUpdateResponse(
                                ResConstants.GUEST_UPDATE + GUEST1_ID,
                                requestGuest);
